...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "enrich":
        ...
        print(
            ...
            f"{rep.units_repaired.get('repaired', 0)} units re-read from magnitude "
            f"(of {rep.units_repaired.get('examined', 0)} suspect); "
            f"{rep.amounts_repaired.get('repaired', 0)} trace amounts re-read as portions; "
