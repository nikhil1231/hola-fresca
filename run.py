...
if __name__ == "__main__":
    ...
    # that the API writes to, so watching it means reload storms mid-request.
    reload_dirs = [os.path.join(ROOT, "app")] if reload else None
    uvicorn.run("main:app", host=host, port=port, reload=reload, reload_dirs=reload_dirs)
